...
const MessageBar = () => {
    ...
    useEffect(() => {
        function handleClickOutside(event) {
          if (emojiRef.current && !emojiRef.current.contains(event.target)) {
            setTimeout(() => setEmojiPickerOpen(false), 100);
          }
        }
    ...
    return <div className='h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 mb-6 gap-6'>
        ...
        <button className='bg-[#8417ff] rounded-md flex items-center justify-center p-5 focus:border-none  focus:bg-[#7216db] focus:outline-none focus:text-white duration-300 transition-all'
